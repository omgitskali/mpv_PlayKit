...
/* Guide images are bound through the G (luma)
...
#if (defined(LUMA_gather)) && ((PS == 0 || ((PS == 3 || PS == 7) && RI != 7) || PS == 8) && P == 3) && REGULAR_ROTATIONS && GATHER
...
#elif (defined(LUMA_gather)) && PS == 4 && P == 3 && RI == 0 && RFI == 0 && GATHER
...
#elif (defined(LUMA_gather)) && PS == 6 && RI == 0 && RFI == 0 && GATHER
